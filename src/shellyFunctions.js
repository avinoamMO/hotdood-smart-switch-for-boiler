...
//TODO: Add documentation and input validation.
...
export function setNewSchedule(sch) {
...
export function deleteAnEvent(sch) {
  let data = JSON.stringify(sch);
  axios
...
export function switchRelayMode(interavlValueInMinutes, props) {
  axios
    .get(`http://localhost:3007/switchRelayMode/${interavlValueInMinutes * 60}`)
    .then(res => {});
}
